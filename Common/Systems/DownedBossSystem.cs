...
namespace Pokemod.Common.Systems
{
	...
	//    NPC.SetEventFlagCleared(ref DownedBossSystem.downedMewtwoBoss, -1);
	...
	{
		public static bool downedMewtwoBoss = false;
		// public static bool downedOtherBoss = false;

		public override void ClearWorld() {
			downedMewtwoBoss = false;
		...
		public override void LoadWorldData(TagCompound tag) {
			downedMewtwoBoss = tag.ContainsKey("downedMewtwoBoss");
		...
		public override void NetSend(BinaryWriter writer) {
			...
			writer.WriteFlags(downedMewtwoBoss/*, downedOtherBoss*/);
		...
		public override void NetReceive(BinaryReader reader) {
			...
			reader.ReadFlags(out downedMewtwoBoss/*, out downedOtherBoss*/);
