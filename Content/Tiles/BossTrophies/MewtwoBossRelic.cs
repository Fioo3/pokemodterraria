...
{ 
    ...
    public class MewtwoBossRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "Pokemod/Content/Tiles/BossTrophies/MewtwoBossRelic";

		// All relics use the same pedestal texture, this one is copied from vanilla
		public override string Texture => "Pokemod/Content/Tiles/BossTrophies/RelicPedestal";
	...
	// Your tile code would then inherit from the MewtwoBossRelic class (which you should make abstract) and should look like this:
	/*
	public class MyBossRelic : MewtwoBossRelic
	{
		public override string RelicTextureName => "BossSetup/Content/Tiles/Furniture/MyBossRelic";
